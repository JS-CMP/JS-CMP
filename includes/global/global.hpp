...
JS::Any Object = JS::Any(std::make_shared<JS::Object>(JS::Properties{
    ...
    {u"keys", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::keys, 1, u"keys")), true, false, true}},
    {u"create", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::create, 1, u"create")), true, false, true}},
    {u"defineProperty",JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::defineProperty, 3, u"defineProperty")), true, false, true}},
    {u"defineProperties",JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::defineProperties, 2, u"defineProperties")), true, false, true}},
    {u"freeze", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::freeze, 1, u"freeze")), true, false, true}},
    {u"getPrototypeOf",JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::getPrototypeOf, 1, u"getPrototypeOf")), true, false, true}},
    {u"getOwnPropertyDescriptor",JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::getOwnPropertyDescriptor, 2, u"getOwnPropertyDescriptor")), true, false, true}},
    {u"getOwnPropertyNames",JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::getOwnPropertyNames, 1, u"getOwnPropertyNames")), true, false, true}},
    {u"isSealed", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::isSealed, 1, u"isSealed")), true, false, true}},
    {u"isFrozen", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::isFrozen, 1, u"isFrozen")), true, false, true}},
    {u"isExtensible", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::isExtensible, 1, u"isExtensible")), true, false, true}},
    {u"preventExtensions",JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::preventExtensions, 1, u"preventExtensions")), true, false, true}},
    {u"seal", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::seal, 1, u"seal")), true, false, true}},
}));
...
JS::Any Array = JS::Any(std::make_shared<JS::Array>(JS::Properties{
    ...
    {u"isArray", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Array::isArray, 1, u"isArray")), true, true, true}},
}));
...
JS::Any String = JS::Any(std::make_shared<JS::String>(JS::Properties{
    ...
    {u"fromCharCode",
     JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::String::fromCharCode, 1, u"fromCharCode")), true, true, true}},
}));
...
JS::Any Math = JS::Any(std::make_shared<JS::InternalObject>(
    JS::Properties{
        {u"abs", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::abs, 1, u"abs")), true, true, true}},
        {u"acos", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::acos, 1, u"acos")), true, true, true}},
        {u"asin", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::asin, 1, u"asin")), true, true, true}},
        {u"atan", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::atan, 1, u"atan")), true, true, true}},
        {u"atan2", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::atan2, 2, u"atan2")), true, true, true}},
        {u"ceil", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::ceil, 1, u"ceil")), true, true, true}},
        {u"cos", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::cos, 1, u"cos")), true, true, true}},
        {u"exp", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::exp, 1, u"exp")), true, true, true}},
        {u"floor", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::floor, 1, u"floor")), true, true, true}},
        {u"log", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::log, 1, u"log")), true, true, true}},
        {u"max", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::max, 2, u"max")), true, true, true}},
        {u"min", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::min, 2, u"min")), true, true, true}},
        {u"pow", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::pow, 2, u"pow")), true, true, true}},
        {u"random", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::random, 0, u"random")), true, true, true}},
        {u"round", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::round, 1, u"round")), true, true, true}},
        {u"sin", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::sin, 1, u"sin")), true, true, true}},
        {u"sqrt", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::sqrt, 1, u"sqrt")), true, true, true}},
        {u"tan", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Math::tan, 1, u"tan")), true, true, true}},
