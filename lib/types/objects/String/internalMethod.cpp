...
std::shared_ptr<JS::Function> JS::String::getConstructor() {
    ...
    constructor->properties = std::make_shared<JS::Properties>(JS::Properties{{u"length", JS::DataDescriptor{JS::Any(0), true, false, false}}, {u"name", JS::DataDescriptor{JS::Any(STRING_CLASS_NAME), false, false, false}}, {u"fromCharCode", JS::DataDescriptor{JS::Any(JS::InternalObject::create<JS::Function>(JS::String::fromCharCode, 1, u"fromCharCode")), true, true, true}}, {u"prototype", JS::DataDescriptor(JS::Any(String::getPrototypeProperties(constructor)), false, false, false)}});
    return constructor;
}