...
std::shared_ptr<JS::InternalObject>& JS::UriError::getPrototypeProperties() {
    static std::unordered_map<std::string, JS::Attribute> properties_prototype = {
        {"toString", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::UriError::toString)), true, true, true}},
        {"name", JS::DataDescriptor{JS::Any("URIError"), true, true, true}},
