...
std::shared_ptr<JS::InternalObject>& JS::String::getPrototypeProperties() {
    static std::unordered_map<std::u16string, JS::Attribute> properties_prototype = {
        ...
        {u"valueOf",
         JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::String::valueOf)), true, true, true}},
        ...
        {u"indexOf",
         JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::String::indexOf)), true, true, true}},
        {u"lastIndexOf",
        ...
        {u"replace",
         JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::String::replace)), true, true, true}},
