...
std::shared_ptr<JS::InternalObject>& JS::Error::getPrototypeProperties() {
    static std::unordered_map<std::u16string, JS::Attribute> properties_prototype = {
        {u"toString",
         JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Error::toString)), true, true, true}},
        {u"name",
         JS::DataDescriptor{JS::Any("Error"), true, true, true}},
        {u"message",
         JS::DataDescriptor{JS::Any(""), true, true, true}},
    };
