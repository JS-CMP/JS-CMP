...
JS::Any Function::apply(const JS::Any& thisArg, const JS::Any& args) {
    if (!JS::COMPARE::Type(thisArg, JS::OBJECT) && !std::get<std::shared_ptr<JS::InternalObject>>(thisArg.getValue())->
        isCallable()) {
    ...
    if (JS::COMPARE::Type(argArray, JS::UNDEFINED) || JS::COMPARE::Type(argArray, JS::NULL_TYPE)) {
        return std::get<std::shared_ptr<JS::InternalObject>>(thisArg.getValue())->call_function(
            thisArg, JS::Arguments::CreateArgumentsObject({}));
    }
    ...
    return std::get<std::shared_ptr<JS::InternalObject>>(thisArg.getValue())->call_function(
        thisArgArg, JS::Arguments::CreateArgumentsObject(argList));
}
...
JS::Any Function::bind(const JS::Any& thisArg, const JS::Any& args) {
    ...
    if (!JS::COMPARE::Type(target, JS::OBJECT) && !std::get<std::shared_ptr<JS::InternalObject>>(target.getValue())->
        isCallable()) {
