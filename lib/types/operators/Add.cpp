...
JS::Any JS::Any::operator+(bool value) const {
    switch (this->value.index()) {
        case NUMBER:
            return JS::Any(std::get<double>(this->value) + value);
        case STRING:
            return JS::Any(std::get<Rope>(this->value) + (value ? "true" : "false"));
        case BOOL:
            return JS::Any(std::get<bool>(this->value) + value);
        case FUNCTION:
            return JS::Any(this->toString() + std::to_string(value));
...
JS::Any JS::Any::operator+(JS::Undefined) const {
    switch (this->value.index()) {
        case NUMBER:
            return JS::Any(std::numeric_limits<double>::quiet_NaN());
        case STRING:
            return JS::Any(this->toString() + std::get<Rope>(this->value));
        case BOOL:
            return JS::Any(std::numeric_limits<double>::quiet_NaN());
        case FUNCTION:
            return JS::Any(this->toString() + this->toString());
        case UNDEFINED:
            return JS::Any(std::numeric_limits<double>::quiet_NaN());
        case NULL_TYPE:
            return JS::Any(std::numeric_limits<double>::quiet_NaN());
    ...
    JS::Any operator+(JS::Undefined, JS::Any const & any) {
        switch (any.getValue().index()) {
            case JS::NUMBER:
                return JS::Any(std::numeric_limits<double>::quiet_NaN());
            case JS::STRING:
                return JS::Any(any.toString() + std::get<Rope>(any.getValue()));
            case JS::BOOL:
                return JS::Any(std::numeric_limits<double>::quiet_NaN());
            case JS::FUNCTION:
                return JS::Any(any.toString() + any.toString());
            case JS::UNDEFINED:
                return JS::Any(std::numeric_limits<double>::quiet_NaN());
            case JS::NULL_TYPE:
                return JS::Any(std::numeric_limits<double>::quiet_NaN());
