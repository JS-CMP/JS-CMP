...
std::shared_ptr<JS::InternalObject>& JS::Function::getPrototypeProperties(const std::shared_ptr<JS::InternalObject>& constructor) {
    ...
    instance->defineOwnProperty(u"toString", JS::DataDescriptor{JS::Any(JS::InternalObject::create<JS::Function>(JS::Function::toString, 0, u"toString", instance)), true, false, true});
    instance->defineOwnProperty(u"apply", JS::DataDescriptor{JS::Any(JS::InternalObject::create<JS::Function>(JS::Function::apply, 2, u"apply", instance)), true, false, true});
    instance->defineOwnProperty(u"call", JS::DataDescriptor{JS::Any(JS::InternalObject::create<JS::Function>(JS::Function::call, 1, u"call", instance)), true, false, true});
    instance->defineOwnProperty(u"bind", JS::DataDescriptor{JS::Any(JS::InternalObject::create<JS::Function>(JS::Function::bind, 1, u"bind", instance)), true, false, true});
    initialized = true;
    return instance;
}
