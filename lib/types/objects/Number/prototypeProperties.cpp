...
std::shared_ptr<JS::InternalObject>& JS::Number::getPrototypeProperties() {
    static std::unordered_map<std::u16string, JS::Attribute> properties_prototype = {
        ...
        {u"valueOf", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Number::valueOf)), true, true, true}},
        {u"toFixed", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Number::toFixed)), true, true, true}},
        {u"toExponential",
