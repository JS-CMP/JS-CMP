 ...
 *
 * The `Object` class represents a JavaScript-like object in C++. It provides methods to access and modify properties of the object.
 * It also provides methods to check if a property exists, and if it's callable.
 */
class Object {
    public:
        /**
