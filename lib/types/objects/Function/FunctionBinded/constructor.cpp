...
FunctionBinded::FunctionBinded(const std::shared_ptr<JS::InternalObject>& TargetFunction, const JS::Any& BoundThis, const std::vector<JS::Any>& BoundArguments) : targetFunction(TargetFunction), boundThis(BoundThis), boundArguments(BoundArguments) {
