...
namespace JS {
Boolean::Boolean() : InternalObject({}, getPrototypeProperties(), BOOL_CLASS_NAME, true) {
...
Boolean::Boolean(const JS::Properties& properties)
    : InternalObject(properties, JS::Function::getPrototypeProperties(), BOOL_CLASS_NAME, true) {
