...
std::shared_ptr<JS::Function> JS::Object::getConstructor() {
    ...
    constructor->properties = std::make_shared<JS::Properties>(JS::Properties({
        ...
        {u"defineProperty", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::defineProperty)), true, false, true}},
        {u"defineProperties", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::defineProperties)), true, false, true}},
        {u"freeze", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::freeze)), true, false, true}},
        {u"getPrototypeOf", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::getPrototypeOf)), true, false, true}},
        {u"getOwnPropertyDescriptor", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::getOwnPropertyDescriptor)), true, false, true}},
        {u"getOwnPropertyNames", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::getOwnPropertyNames)), true, false, true}},
        ...
        {u"isExtensible", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::isExtensible)), true, false, true}},
        {u"preventExtensions", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Object::preventExtensions)), true, false, true}},
