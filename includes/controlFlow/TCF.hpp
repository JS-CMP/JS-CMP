...
#define TCF_RETURN(val) __tcf_value = (val); __tcf_state = RETURN; goto finally;
#define TCF_BREAK __tcf_state = BREAK; goto finally;
#define TCF_CONTINUE __tcf_state = CONTINUE; goto finally;
#define TCF_THROW(val) __tcf_value = (val); __tcf_state = THROW; goto finally;
