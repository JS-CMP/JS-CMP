...
std::shared_ptr<JS::InternalObject>& JS::TypeError::getPrototypeProperties() {
    static std::unordered_map<std::string, JS::Attribute> properties_prototype = {
        {"toString", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::TypeError::toString)), true, true, true}},
        {"name", JS::DataDescriptor{JS::Any("TypeError"), true, true, true}},
