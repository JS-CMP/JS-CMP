...
std::shared_ptr<JS::InternalObject>& JS::NativeError::getPrototypeProperties() {
    static std::unordered_map<std::u16string, JS::Attribute> properties_prototype = {
        {u"toString", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::NativeError::toString)), true, true, true}},
        {u"name", JS::DataDescriptor{JS::Any(u"NativeError"), true, true, true}},
        {u"message", JS::DataDescriptor{JS::Any(u""), true, true, true}},
    };
