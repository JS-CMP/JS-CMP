...
std::optional<JS::Match> JS::Regex::match(const std::u16string& str, uint32_t pos) const {
...
// prototype methods
JS::Any JS::Regex::exec(const JS::Any& thisArg, const JS::Any& args) {
    ...
    JS::Array A = JS::Array({}); // TODO can be change to JS::Any(JS::Arra());
    int matchIndex = i;
...
JS::Any JS::Regex::test(const JS::Any& thisArg, const JS::Any& args) {
    return JS::Any(!JS::COMPARE::Type(JS::Regex::exec(thisArg, args), JS::NULL_TYPE));
}
