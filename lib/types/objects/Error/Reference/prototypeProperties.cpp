...
std::shared_ptr<JS::InternalObject>& JS::ReferenceError::getPrototypeProperties() {
    static std::unordered_map<std::string, JS::Attribute> properties_prototype = {
        {"toString", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::ReferenceError::toString)), true, true, true}},
        {"name", JS::DataDescriptor{JS::Any("ReferenceError"), true, true, true}},
