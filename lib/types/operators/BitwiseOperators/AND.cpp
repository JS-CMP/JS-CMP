        ...
        switch (any.getValue().index()) {
            case NUMBER:
                switch (other.getValue().index()) {
                    case NUMBER:
                        return static_cast<int>(std::get<double>(any.getValue())) &
                               static_cast<int>(std::get<double>(any.getValue()));
                    case STRING:
                        return static_cast<int>(std::get<double>(any.getValue())) &
                               static_cast<int>(std::stod(std::get<Rope>(any.getValue()).toString()));
                    case BOOL:
                        return static_cast<int>(std::get<double>(any.getValue())) &
                               static_cast<int>(std::get<bool>(any.getValue()));
                    default:
            ...
            case STRING:
                switch (any.getValue().index()) {
                    case NUMBER:
                        return static_cast<int>(std::stod(std::get<Rope>(any.getValue()).toString())) &
                               static_cast<int>(std::get<double>(any.getValue()));
                    case STRING:
                        return static_cast<int>(std::stod(std::get<Rope>(any.getValue()).toString())) &
                               static_cast<int>(std::stod(std::get<Rope>(any.getValue()).toString()));
            ...
            case BOOL:
                switch (any.getValue().index()) {
                    case NUMBER:
                        return static_cast<int>(std::get<bool>(any.getValue())) &
                               static_cast<int>(std::get<double>(any.getValue()));
                    case STRING:
                        return static_cast<int>(std::get<bool>(any.getValue())) &
                               static_cast<int>(std::stod(std::get<Rope>(any.getValue()).toString()));
