...
std::shared_ptr<JS::Function> JS::ReferenceError::getConstructor() {
    ...
    static auto constructor = JS::InternalObject::create<JS::Function>([](const JS::Any& thisArg, const JS::Any& args) -> JS::Any { return JS::Any(JS::InternalObject::create<JS::ReferenceError>(args[u"0"])); }, 1, ERROR_CLASS_NAME, prototype);
    ...
    constructor->properties = std::make_shared<JS::Properties>(JS::Properties{
        ...
        {u"name", JS::DataDescriptor{JS::Any("ReferenceError"), false, false, false}},
    });
    return constructor;
}
