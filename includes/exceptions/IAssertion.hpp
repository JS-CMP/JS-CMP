...
public:
    IAssertion(JS::Any act, JS::Any exp, std::string msg, std::string ope, std::string cd, std::string nm)
        : message(std::move(msg)), code(std::move(cd)), name(std::move(nm)), actual(std::move(act)),
          expected(std::move(exp)), operator_(std::move(ope)) {}
