...
std::shared_ptr<JS::InternalObject>& JS::Array::getPrototypeProperties() {
    static std::unordered_map<std::u16string, JS::Attribute> properties_prototype = {
        {u"toString", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Array::toString)), true, true, true}},
        {u"toLocaleString", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Array::toLocaleString)), true, true, true}},
        ...
        {u"lastIndexOf", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Array::lastIndexOf)), true, true, true}},
        ...
        {u"reduceRight", JS::DataDescriptor{JS::Any(std::make_shared<JS::Function>(JS::Array::reduceRight)), true, true, true}},
    };
