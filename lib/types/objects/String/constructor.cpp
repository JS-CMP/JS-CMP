...
String::String() : JS::InternalObject({}, getPrototypeProperties(), "String", true) {
    ...
    this->defineOwnProperty("length", JS::DataDescriptor{JS::Any(0), false, false, false});
    this->defineOwnProperty("prototype", JS::DataDescriptor{JS::Any(getPrototypeProperties()), false, false, false});
}
...
String::String(const JS::Any& value) : JS::InternalObject({}, getPrototypeProperties(), "String", true) {
    ...
    this->defineOwnProperty("length", JS::DataDescriptor{JS::Any(int(v.length())), false, false, false});
    this->defineOwnProperty("prototype", JS::DataDescriptor{JS::Any(getPrototypeProperties()), false, false, false});
}
