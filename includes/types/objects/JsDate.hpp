...
public:
     ...
     */
    ///@{
    /** @brief Returns a string representing the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.4.2*/
    static JS::Any toString(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns a string representing the specified Date object's date portion. https://262.ecma-international.org/5.1/#sec-15.9.5.3*/
    static JS::Any toDateString(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns a string representing the specified Date object's time portion. https://262.ecma-international.org/5.1/#sec-15.9.5.4*/
    static JS::Any toTimeString(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns a string with a language-sensitive representation of this date. https://262.ecma-international.org/5.1/#sec-15.9.5.5*/
    static JS::Any toLocaleString(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns a string with a language-sensitive representation of this date's date portion. https://262.ecma-international.org/5.1/#sec-15.9.5.6*/
    static JS::Any toLocaleDateString(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns a string with a language-sensitive representation of this date's time portion. https://262.ecma-international.org/5.1/#sec-15.9.5.7*/
    static JS::Any toLocaleTimeString(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns the primitive value of the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.5.8*/
    static JS::Any valueOf(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns the number of milliseconds since 1 January 1970 00:00:00 UTC. https://262.ecma-international.org/5.1/#sec-15.9.5.9*/
    ...
    /** @brief Returns the day of the month of the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.5.14*/
    static JS::Any getDate(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns the day of the month of the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.5.15*/
    static JS::Any getUTCDate(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns the day of the week of the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.5.16*/
    static JS::Any getDay(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns the day of the week of the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.5.17*/
    ...
    /** @brief Returns the millisecond of the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.5.24*/
    static JS::Any getMilliseconds(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns the millisecond of the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.5.25*/
    static JS::Any getUTCMilliseconds(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns the timezone offset of the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.5.26*/
    static JS::Any getTimezoneOffset(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Sets the Date object to the time represented by a number. https://262.ecma-international.org/5.1/#sec-15.9.5.27*/
    static JS::Any setTime(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Sets the milliseconds of the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.5.28*/
    static JS::Any setMilliseconds(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Sets the milliseconds of the specified Date object. https://262.ecma-international.org/5.1/#sec-15.9.5.29*/
    ...
    /** @brief Returns a string representing the specified Date object in UTC time. https://262.ecma-international.org/5.1/#sec-15.9.5.42*/
    static JS::Any toUTCString(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns a string representing the specified Date object in ISO format. https://262.ecma-international.org/5.1/#sec-15.9.5.43*/
    static JS::Any toISOString(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns a string representing the specified Date object in JSON format. https://262.ecma-international.org/5.1/#sec-15.9.5.44*/
     ...
     */
    ///@{
    /** @brief Parses a string and returns the number of milliseconds since 1 January 1970 00:00:00 UTC. https://262.ecma-international.org/5.1/#sec-15.9.4.2*/
    static JS::Any parse(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns the number of milliseconds since 1 January 1970 00:00:00 UTC. https://262.ecma-international.org/5.1/#sec-15.9.4.3*/
    static JS::Any UTC(const JS::Any& thisArg, const JS::Any& args);
    /** @brief Returns the number of milliseconds since 1 January 1970 00:00:00 UTC.  https://262.ecma-international.org/5.1/#sec-15.9.4.4*/
